...
<main>
    ...
    <article class="wrapper">
        <h1 class="header header--main">PVM Sąskaita-faktūra</h1>
        ...
        <section class="grid-container">
            ...
            <div class="grid-item">
                ...
                <p>Description:  <?php print $product['descrip']; ?></p>
                <p><?php print $product['price']; ?> $</p>
                <p>Email/skype/telephone: <?php print $product['contact']; ?></p>
            </div>
        </section>
    </article>
</main>
